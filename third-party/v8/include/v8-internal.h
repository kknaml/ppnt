...
constexpr inline Address kNullAddress = 0;

constexpr inline int KB = 1024;
constexpr inline int MB = KB * 1024;
constexpr inline int GB = MB * 1024;
#ifdef V8_TARGET_ARCH_X64
constexpr inline size_t TB = size_t{GB} * 1024;
#endif

/**
 * Configuration of tagging scheme.
 */
constexpr inline int kApiSystemPointerSize = sizeof(void*);
constexpr inline int kApiDoubleSize = sizeof(double);
constexpr inline int kApiInt32Size = sizeof(int32_t);
constexpr inline int kApiInt64Size = sizeof(int64_t);
constexpr inline int kApiSizetSize = sizeof(size_t);

// Tag information for HeapObject.
constexpr inline int kHeapObjectTag = 1;
constexpr inline int kWeakHeapObjectTag = 3;
constexpr inline int kHeapObjectTagSize = 2;
constexpr inline intptr_t kHeapObjectTagMask = (1 << kHeapObjectTagSize) - 1;
constexpr inline intptr_t kHeapObjectReferenceTagMask = 1 << (kHeapObjectTagSize - 1);

// Tag information for fowarding pointers stored in object headers.
// 0b00 at the lowest 2 bits in the header indicates that the map word is a
// forwarding pointer.
constexpr inline int kForwardingTag = 0;
constexpr inline int kForwardingTagSize = 2;
constexpr inline intptr_t kForwardingTagMask = (1 << kForwardingTagSize) - 1;

// Tag information for Smi.
constexpr inline int kSmiTag = 0;
constexpr inline int kSmiTagSize = 1;
constexpr inline intptr_t kSmiTagMask = (1 << kSmiTagSize) - 1;
...
// compression.
constexpr inline size_t kPtrComprCageReservationSize = size_t{1} << 32;
constexpr inline size_t kPtrComprCageBaseAlignment = size_t{1} << 32;

static_assert(
    kApiSystemPointerSize == kApiInt64Size,
    "Pointer compression can be enabled only for 64-bit architectures");
constexpr inline int kApiTaggedSize = kApiInt32Size;
#else
...
#else
constexpr inline  size_t kExternalPointerTableReservationSize = 512 * MB;
constexpr inline  uint32_t kExternalPointerIndexShift = 6;
#endif  // V8_TARGET_OS_ANDROID

// The maximum number of entries in an external pointer table.
constexpr inline int kExternalPointerTableEntrySize = 8;
constexpr inline int kExternalPointerTableEntrySizeLog2 = 3;
constexpr inline size_t kMaxExternalPointers =
...
constexpr inline uint64_t kExternalPointerMarkBit = 1ULL << 48;
constexpr inline uint64_t kExternalPointerTagShift = 49;
constexpr inline uint64_t kExternalPointerTagMask = 0x00fe000000000000ULL;
constexpr inline uint64_t kExternalPointerShiftedTagMask =
...
constexpr inline uint64_t kExternalPointerTagAndMarkbitMask = 0x00ff000000000000ULL;
constexpr inline uint64_t kExternalPointerPayloadMask = 0xff00ffffffffffffULL;
...
constexpr inline ExternalPointer_t kNullExternalPointer = 0;
constexpr inline ExternalPointerHandle kNullExternalPointerHandle = 0;
...
constexpr inline CppHeapPointer_t kNullCppHeapPointer = 0;
constexpr inline CppHeapPointerHandle kNullCppHeapPointerHandle = 0;

constexpr inline uint64_t kCppHeapPointerMarkBit = 1ULL;
constexpr inline uint64_t kCppHeapPointerTagShift = 1;
constexpr inline uint64_t kCppHeapPointerPayloadShift = 16;
...
constexpr inline  ExternalPointerTagRange kAnyExternalPointerTagRange(
    kFirstExternalPointerTag, kLastExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnySharedExternalPointerTagRange(
    kFirstSharedExternalPointerTag, kLastSharedExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnyForeignExternalPointerTagRange(
    kFirstForeignExternalPointerTag, kLastForeignExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnyInterceptorInfoExternalPointerTagRange(
    kFirstInterceptorInfoExternalPointerTag,
    kLastInterceptorInfoExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnyManagedExternalPointerTagRange(
    kFirstManagedExternalPointerTag, kLastManagedExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnyMaybeReadOnlyExternalPointerTagRange(
    kFirstMaybeReadOnlyExternalPointerTag,
    kLastMaybeReadOnlyExternalPointerTag);
constexpr inline ExternalPointerTagRange kAnyManagedResourceExternalPointerTag(
...
V8_INLINE constexpr bool IsSharedExternalPointerType(
...
// pointer table.
V8_INLINE constexpr bool IsMaybeReadOnlyExternalPointerType(
    ExternalPointerTagRange tag_range) {
...
V8_INLINE constexpr bool IsManagedExternalPointerType(
    ExternalPointerTagRange tag_range) {
...
V8_INLINE constexpr bool ExternalPointerCanBeEmpty(
    ExternalPointerTagRange tag_range) {
